...
def convertir_pdf_a_html(pdf_path, html_path):
    ...
    # Estructura para almacenar el contenido - más simple y directa
    sections = []
    ...
    def save_content_to_current_section():
        """Guarda el contenido del buffer en la sección actual"""
        nonlocal content_buffer, current_subsubsection, current_subsection, current_section
        
        if content_buffer.strip():
            # Determinar dónde guardar el contenido basado en la jerarquía actual
        ...
        with pdfplumber.open(pdf_path) as pdf:
            ...
            while i < len(lines):
                ...
                if section_type == 'section':
                    ...
                    save_content_to_current_section()
