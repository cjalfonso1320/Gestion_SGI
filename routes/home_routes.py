...
def home():
    ...
    if rol == 1:
        return render_template('home_admin.html', usuario=current_user, usuarios_cuenta=usuarios_cuenta, roles_cuenta=roles_cuenta, imagen_rol=imagen_rol)
    else:
        return render_template('home.html', usuario=current_user, procesos=procesos, imagen_rol=imagen_rol)